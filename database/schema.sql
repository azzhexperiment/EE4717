...
INSERT INTO products
    VALUES
(	25302	,	253	,	"Gucci"	,	"GG lamé baseball hat"	,	"A sparkling version of the House's emblematic monogram animates this baseball hat in white and silver GG lamé. First used in the 1970s, the GG logo was an evolution of the original Gucci rhombi design from the 1930s. The sparkling material’s retro appeal adds a bon ton influence to a contemporary shape, reflecting the House's hybrid spirit."	,	1	,	29.02	,	1	,	1	,	0	,	CURRENT_TIMESTAMP	,	NULL	),
...
(	12402	,	124	,	"DIOR"	,	"DIOR AND SHAWN Track Shorts"	,	"The navy blue running shorts feature a DIOR AND SHAWN bouclé signature embroidered on the front. They are cut with a mid-rise drawstring waist and fit in a medium length. The shorts can be worn with the matching the track jacket, for a relaxed style."	,	3	,	364.07	,	1	,	1	,	1	,	CURRENT_TIMESTAMP	,	NULL	),
...
(	13102	,	131	,	"Zara"	,	"LEATHER LOAFERS WITH APPLIQUÉ - LIMITED EDITION"	,	"Leather loafers with contrast colours on the upper. Decorative trim on the instep with metal appliqué. Chunky black welt sole. Leather insole. Rounded toe."	,	4	,	868.99	,	1	,	0	,	1	,	CURRENT_TIMESTAMP	,	NULL	),
...
INSERT INTO stocks
    VALUES
        (25302, 200 , CURRENT_TIMESTAMP, NULL),
        (25202, 200 , CURRENT_TIMESTAMP, NULL),
        (25402, 200 , CURRENT_TIMESTAMP, NULL),
        (25502, 200 , CURRENT_TIMESTAMP, NULL),
        (25501, 200 , CURRENT_TIMESTAMP, NULL),
        (25401, 200 , CURRENT_TIMESTAMP, NULL),
        (25102, 200 , CURRENT_TIMESTAMP, NULL),
        (25101, 200 , CURRENT_TIMESTAMP, NULL),
        (25201, 200 , CURRENT_TIMESTAMP, NULL),
        (25301, 200 , CURRENT_TIMESTAMP, NULL),
        (15402, 200 , CURRENT_TIMESTAMP, NULL),
        (15302, 200 , CURRENT_TIMESTAMP, NULL),
        (15502, 200 , CURRENT_TIMESTAMP, NULL),
        (15401, 200 , CURRENT_TIMESTAMP, NULL),
        (15301, 200 , CURRENT_TIMESTAMP, NULL),
        (15201, 200 , CURRENT_TIMESTAMP, NULL),
        (15202, 200 , CURRENT_TIMESTAMP, NULL),
        (15501, 200 , CURRENT_TIMESTAMP, NULL),
        (15102, 200 , CURRENT_TIMESTAMP, NULL),
        (15101, 200 , CURRENT_TIMESTAMP, NULL),
        (22302, 200 , CURRENT_TIMESTAMP, NULL),
        (22101, 200 , CURRENT_TIMESTAMP, NULL),
        (22102, 200 , CURRENT_TIMESTAMP, NULL),
        (22402, 200 , CURRENT_TIMESTAMP, NULL),
        (22401, 200 , CURRENT_TIMESTAMP, NULL),
        (22202, 200 , CURRENT_TIMESTAMP, NULL),
        (22501, 200 , CURRENT_TIMESTAMP, NULL),
        (22502, 200 , CURRENT_TIMESTAMP, NULL),
        (22201, 200 , CURRENT_TIMESTAMP, NULL),
        (22301, 200 , CURRENT_TIMESTAMP, NULL),
        (12102, 200 , CURRENT_TIMESTAMP, NULL),
        (12302, 200 , CURRENT_TIMESTAMP, NULL),
        (12301, 200 , CURRENT_TIMESTAMP, NULL),
        (12201, 200 , CURRENT_TIMESTAMP, NULL),
        (12101, 200 , CURRENT_TIMESTAMP, NULL),
        (12202, 200 , CURRENT_TIMESTAMP, NULL),
        (12402, 200 , CURRENT_TIMESTAMP, NULL),
        (12401, 200 , CURRENT_TIMESTAMP, NULL),
        (23101, 200 , CURRENT_TIMESTAMP, NULL),
        (23201, 200 , CURRENT_TIMESTAMP, NULL),
        (23301, 200 , CURRENT_TIMESTAMP, NULL),
        (23102, 200 , CURRENT_TIMESTAMP, NULL),
        (23401, 200 , CURRENT_TIMESTAMP, NULL),
        (23202, 200 , CURRENT_TIMESTAMP, NULL),
        (23302, 200 , CURRENT_TIMESTAMP, NULL),
        (23402, 200 , CURRENT_TIMESTAMP, NULL),
        (13301, 200 , CURRENT_TIMESTAMP, NULL),
        (13402, 200 , CURRENT_TIMESTAMP, NULL),
        (13201, 200 , CURRENT_TIMESTAMP, NULL),
        (13202, 200 , CURRENT_TIMESTAMP, NULL),
        (13302, 200 , CURRENT_TIMESTAMP, NULL),
        (13102, 200 , CURRENT_TIMESTAMP, NULL),
        (13401, 200 , CURRENT_TIMESTAMP, NULL),
        (13101, 200 , CURRENT_TIMESTAMP, NULL),
        (13203, 200 , CURRENT_TIMESTAMP, NULL),
        (24301, 200 , CURRENT_TIMESTAMP, NULL),
        (24201, 200 , CURRENT_TIMESTAMP, NULL),
        (24101, 200 , CURRENT_TIMESTAMP, NULL),
        (24302, 200 , CURRENT_TIMESTAMP, NULL),
        (24102, 200 , CURRENT_TIMESTAMP, NULL),
        (24202, 200 , CURRENT_TIMESTAMP, NULL),
        (21102, 200 , CURRENT_TIMESTAMP, NULL),
        (21302, 200 , CURRENT_TIMESTAMP, NULL),
        (21501, 200 , CURRENT_TIMESTAMP, NULL),
        (21201, 200 , CURRENT_TIMESTAMP, NULL),
        (21202, 200 , CURRENT_TIMESTAMP, NULL),
        (21402, 200 , CURRENT_TIMESTAMP, NULL),
        (21401, 200 , CURRENT_TIMESTAMP, NULL),
        (21301, 200 , CURRENT_TIMESTAMP, NULL),
        (21101, 200 , CURRENT_TIMESTAMP, NULL),
        (21502, 200 , CURRENT_TIMESTAMP, NULL),
        (11202, 200 , CURRENT_TIMESTAMP, NULL),
        (11201, 200 , CURRENT_TIMESTAMP, NULL),
        (11401, 200 , CURRENT_TIMESTAMP, NULL),
        (11302, 200 , CURRENT_TIMESTAMP, NULL),
        (11103, 200 , CURRENT_TIMESTAMP, NULL),
        (11101, 200 , CURRENT_TIMESTAMP, NULL),
        (11301, 200 , CURRENT_TIMESTAMP, NULL),
        (11102, 200 , CURRENT_TIMESTAMP, NULL),
        (11402, 200 , CURRENT_TIMESTAMP, NULL);
